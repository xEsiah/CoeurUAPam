...
import { DEFAULT_OVERVIEW_TAB, TABS_KEYS } from '@/data/tabs';
...
<template>
	<div :id="`plugin-expansion-${toKebabCase(integration.id)}`" class="plugin-expansion-content">
		<div v-if="currentTab === TABS_KEYS.OVERVIEW_TAB_ECOMMERCE" class="plugin-expansion-content__coming-soon-notice">
			<HIcon name="ic-info-circle-filled-24" />
			<p>{{ translate('hostinger_reach_coming_soon_notice') }}</p>
		</div>
